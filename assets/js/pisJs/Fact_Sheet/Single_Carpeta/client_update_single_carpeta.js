    ...
    var __fields = function() {
        __executeExternalGet('8000/petitioner/'+client_id).done(function (result) {
            ...
            if (result.status != "ERROR") {
                ...
                // disply the datas for the update
                ...
                $(".religion").val(result.religion).trigger("change");
                $(".pdl_remarks").val(result.remarks);
                ...
                var investigation_counter = -1;
                var item = 0;
                var supervision_counter = -1;
                var originatedFromTheFieldCounter = -1;
                var walkInCounter = -1;
                var itemSupervision = 0;
                var itemSupervisionORFF = 0;
                                            ...
                                            <div class="card-body" id="investigation_body_${investigation_counter}">
                                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        ...
                                                        <div class="col-12 col-md-8"><input type="date" class="form-control forwarded_date_to_fo" value="${data.date_forwarded_to_fo}"></div>
                                                    </div>
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                ...
                                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        ...
                                                        <div class="col-12 col-md-8"><input type="date" class="form-control forwarded_date_to_ro" value="${data.forwarded_date_to_ro}"></div>
                                                    </div>
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                ...
                                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        ...
                                                        <div class="col-12 col-md-8"><input type="date" class="form-control transmittal_bpp_date" value=${data.transmittal_bpp_date}></div>
                                                    </div>
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div class="col col-md-4"><label for="text-input" class=" form-control-label">Transmital Date from Field Office</label></div>
                                                        <div class="col-12 col-md-8"><input type="date" class="form-control transmittal_date_from_fo" value=${data.transmittal_date_from_fo}></div>
                                                    </div>
                                                </div>
                                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Received by TSD</label></div>
                                                        <div class="col-12 col-md-8"><input type="date" class="form-control received_date_by_tsd" value=${data.received_date_by_tsd}></div>
                                                    </div>
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Forwarded to BPP</label></div>
                                                        <div class="col-12 col-md-8"><input type="date" class="form-control forwarded_to_bpp" value=${data.forwarded_to_bpp}></div>
                                                    </div>
                                                </div>
                                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        <div class="col col-md-4"><label for="text-input" class=" form-control-label">Indorsement Date</label></div>
                                                        <div class="col-12 col-md-8"><input type="date" class="form-control indorsement_date" value="${data.indorsement_date}"></div>
                                                    </div>
                                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            ...
                                            <div class="supervision_body collapse hide" id="supervision_accordion_${supervision_counter}" data-parent="#supervision_accordion_card">
                                                <div class="card-body" id="supervision_body_${supervision_counter}">
                                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date of Transmittal from BPP</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control transmittal_bpp_date" value="${supervision_bpp_data.transmittal_bpp_date}"></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class="form-control-label">Date Received by TSD</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control received_date_by_tsd" value="${supervision_bpp_data.received_date_by_tsd}"></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Forwarded to Field Office</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control transmittal_date_from_fo" value="${supervision_bpp_data.transmittal_date_from_fo}"></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        ...
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            ...
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control date_forwarded_to_ro_sup" value="${supervision_bpp_data.date_forwarded_to_ro_sup}"></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                        ...
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Indorsement Date</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control indorsement_date" value="${supervision_bpp_data.indorsement_date}"></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                ...
                                                <div class="card-body supervision_orff_body_${originatedFromTheFieldCounter}">
                                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6" id="date_transmittal_fo_field">
                                                            ...
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control transmittal_bpp_date_ortftf" value=${supervision_orff_data.transmittal_bpp_date_ortftf}></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Received by TSD</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control date_received_by_tsd_orftf" value=${supervision_orff_data.date_received_by_tsd_orftf}></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6" id="date_forwarded_bpp_field">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Forwarded to BPP</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control forwarded_to_bpp" value=${supervision_orff_data.forwarded_to_bpp}></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Indorsement Date</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control indorsement_date_ortftf" value=${supervision_orff_data.indorsement_date_ortftf}></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Returned to the Field Office</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control returned_date_to_fo_ortftf" value=${supervision_orff_data.returned_date_to_fo_ortftf}></div>
                                                        </div>
                                                    ...
                                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            ...
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control returned_date_to_ro_ortftf" value=${supervision_orff_data.returned_date_to_ro_ortftf}></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Regional Office</label></div>
                                                            <div class="col-12 col-md-8">
                                            ...
                                            <div class="collapse hide" id="supervision_walk_in_accordion_${walkInCounter}" data-parent="#supervision_walk_in_card">
                                                <div class="card-body supervision_walk_in_body_${walkInCounter}">
                                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Received by TSD</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control date_received_by_tsd_walk_in" value=${supervision_walkIn_data.date_received_by_tsd_walk_in}></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Indorsement Date</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control indorsement_date_walk_in" value=${supervision_walkIn_data.indorsement_date_walk_in}></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Date Forwarded to Field Office</label></div>
                                                            <div class="col-12 col-md-8"><input type="date" class="form-control date_forwarded_to_fo_walk_in" value=${supervision_walkIn_data.date_forwarded_to_fo_walk_in}></div>
                                                        </div>
                                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="col col-md-4"><label for="text-input" class=" form-control-label">Field Office</label></div>
                                                            <div class="col-12 col-md-8">
                ...
                $(document).on("click", ".btn-confirm", function(){
                    ...
                    let data;
                    var idData = id;
                    console.log("Id for Investigation: ", idData)
                ...
                // for appending investigation item
                ...
                // for deleting investigation item start
                ...
                // for deleting investigation item send
                ...
                // for adding supervision under bpp resolutions
                    $(document).on("click", ".add_more_supervision", function () {
                        supervision_counter++;
                        itemSupervision++;
                        $(`#supervision_accordion_card`).append(`
                            <div class="card" id="supervision_card_${supervision_counter}" style="border-radius: 10px; margin-bottom: 0px;">
                ...
                // for adding supervision under originated from the field offices
                    $(document).on("click", ".add_more_supervision_originated_from_the_field", function () {
                        originatedFromTheFieldCounter++;
                        itemSupervisionORFF++;
                        $(`#supervision_originated_from_the_field_accordion_card`).append(`
                            <div class="card" id="supervision_orff_card_${originatedFromTheFieldCounter}" style="border-radius: 10px; margin-bottom: 0px">
                ...
                // for adding supervision under walk in
                    $(document).on("click", ".add_more_supervision_walk_in", function () {
                        walkInCounter++;
                        itemSupervisionWalkIn++;
                        $("#supervision_walk_in_accordion_card").append(`
                            <div class="card" id="supervision_walk_in_card_${walkInCounter}" style="border-radius: 10px; margin-bottom: 0px">
                ...
                // for deleting supervisions start
                    $(document).on("click", ".delete_supervision", function (){
                        let id = $(this).data("id");
