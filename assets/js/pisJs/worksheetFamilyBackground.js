            ...
            if (result.status != "ERROR") {
                if (result.worksheetStatus == "INCOMPLETE"){
                    ...
                    familybg.siblings.forEach(function(data){
                        ...
                        $(`.list_sibling .remove`).first().hide();

                        // Show all other close buttons
                        $(`.list_sibling .remove`).not(":first").show();
                    });
                }else{
                    $(".list_siblings").append(`
                        <div class="list_sibling">
                            <div class="row form-group col-md-12">
                                ...
                                <div class="col-3 col-md-2">
                                    <select class="form-control sibling_sex select2">
                                        <option value="n/a" selected disabled>Sex</option>
                                        <option value="FEMALE">Female</option>
                                        <option value="MALE">Male</option>
                                        <option value="LGBT">LGBT</option>
                                    </select>
                                ...
                                <div class="col-3 col-md-2">
                                    <select class="form-control sibling_education select2">
                                        <option value="n/a" selected disabled>Education</option>
                                        <option value="COLLEGE GRADUATE">College Graduate</option>
                                        <option value="COLLEGE UNDERGRADUATE">College Undergraduate</option>
                                        <option value="ELEMENTARY GRADUATE">Elementary Graduate</option>
                                        <option value="ELEMENTARY UNDERGRADUATE">Elementary Undergraduate</option>
