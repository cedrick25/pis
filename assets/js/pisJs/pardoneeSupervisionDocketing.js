            ...
            $(document).ready(function(){
                $('.table_head').DataTable({
                    ...
                    "ajax": function(data, callback, settings) {
                        ...
                        const apiUrl = api+"8000/docketbook?page="+page+"&size="+size+"&type=SC_PD_SUP&officeId="+$.cookie('field_office_id');
                        $.ajax({
                            url: apiUrl,
                            method: 'GET',
                            dataType: 'json',
