                ...
                __executeExternalGet('8000/docketbook/'+docket_number+'/'+fi).done(function (result) {
                    ...
                    $(".btn-confirm").unbind("click").on("click", function(){
                        ...
                        if (fileToUpload === undefined) {
                            ...
                            var settings = {
                                "url": api+"8080/file/upload?uuid="+result.docketNumber+"&type=investigation"+"&createdby="+fullname+"&version=0&kind="+fileToUpload.name+"&officeId="+officeId+"&remarks="+$(".type").val(),
                                "method": "POST",
                                "timeout": 0,
                                "processData": false,
                                "mimeType": "multipart/form-data",
