    ( function ( $ ) {
        ...
        function buttonFunctionality(){
            ...
            $(".btn_update").unbind("click").on("click", function(){
                var docket_number = $(this).data("docket");
                window.location.href = api+'/pis/pardonee_investigation_update?docket_number='+docket_number;
            })
            $(".btn_view").unbind("click").on("click", function(){
                var docket_number = $(this).data("docket");
                window.location.href = api+'/pis/pardone_investigation_view?docket_number='+docket_number;
            })
        }
