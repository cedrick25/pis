    ( function ( $ ) {
        ...
        __executeExternalGet('worksheet/getPetitioner/socioEconomic/'+client_id).done(function (result) {
                ...
                __executeExternalGet('worksheet/getPetitioner/psirSocioEconomic/'+client_id).done(function (result) {
        ...
        $(".btn-update").unbind("click").on("click", function(){
            ...
            __executeExternalPost('worksheet/updatePetitioner/psirSocioEconomic/'+client_id,JSON.stringify(payload)).done(function (result) {
                console.log(result);
                if (result.status != "ERROR") {
                    $(".form-control").val('');
                    $('#success').show();
