                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="col-12 col-md-9" style="padding-right: 0px; padding-left: 20px;"><input type="text" name="text-input" placeholder="Enter Crimnal Case Number" class="form-control cc_no_update"></div>
                                    </div>
                                </div>
