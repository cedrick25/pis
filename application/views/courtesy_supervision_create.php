                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group col-md-12">
                                        <div class="col col-md-1"><label for="text-input" class=" form-control-label">Reasons for referral</label></div>
                                        <div class="col-12 col-md-11"><textarea rows="2" cols="50" class="form-control reasons"></textarea></div>
                                </div>
                                <div class="row form-group col-md-6">
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="e.g Marikina" class="form-control b_place"></div>
                                </div>
                            </div>
