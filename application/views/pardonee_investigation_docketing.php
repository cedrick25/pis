                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" id="pager">
                                ...
                                <a href="pardonee_investigation_create"> <button class="btn btn-sm btn-success float-right pd_inv_add" style='display:none;' type="submit"><i class="fa fa-plus-circle"></i> Add Docket</button> </a>
                            </div>
                            <div class="card-body">
