                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Update Single Carpeta List</strong>
                            </div>
                            <div class="card-body">
            ...
            __executeExternalGet('8000/docketbook/'+docket_number).done(function (result) {
                ...
                if (result.status != "ERROR") {
                    ...
                    $(".btn-confirm_update").unbind("click").on("click", function(){
                        ...
                        __executeExternalPost('8000/docketbook/update/'+docket_number,JSON.stringify(payload)).done(function (result) {
                            console.log(result);
                            if (result.status != "ERROR") {
                            $('#success_update').show();
                                setTimeout(function () {
