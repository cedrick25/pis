                    ...
                    result.content.forEach(function(data){
                        ...
                        __executeExternalGet('http://localhost:8088/user/'+data.senderId).done(function (result) {
                            ...
                            case "COMPLETED":
                                ...
                                break;
                            default:
                                actions = " <button class='btn btn-sm btn-primary btn_upload_inv pr_inv_upload type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"' data-type='"+data.type+"' data-fi='"+field+"'><i class='fa fa-upload'></i> Upload</button> <button class='btn btn-sm btn-danger btn_return_inv pr_inv_return type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-undo'></i> Return</button> <button class='btn btn-sm btn-info btn_forward_inv pr_inv_forward type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-forward'></i> Forward</button> <button class='btn btn-sm btn-success btn_complete_inv pr_inv_complete type='submit' data-toggle='modal' data-target='#completeModal_inv'data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-check-circle'></i> Complete</button>";
                                break;
                            };
                    ...
                    result.content.forEach(function(data){
                        ...
                        __executeExternalGet('http://localhost:8088/user/'+data.senderId).done(function (result) {
                            ...
                            case "COMPLETED":
                                ...
                                break;
                            default:
                                actions = " <button class='btn btn-sm btn-primary btn_upload_cinv pr_cinv_upload type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"' data-type='"+data.type+"' data-fi='"+field+"'><i class='fa fa-upload'></i> Upload</button> <button class='btn btn-sm btn-danger btn_return_cinv pr_cinv_return type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-undo'></i> Return</button> <button class='btn btn-sm btn-info btn_forward_cinv pr_cinv_forward type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-forward'></i> Forward</button> <button class='btn btn-sm btn-success btn_complete_cinv pr_cinv_complete type='submit' data-toggle='modal' data-target='#completeModal_cinv'data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-check-circle'></i> Complete</button>";
                                break;
                            };
                    ...
                    result.content.forEach(function(data){
                        ...
                        __executeExternalGet('http://localhost:8088/user/'+data.senderId).done(function (result) {
                            ...
                            case "COMPLETED":
                                ...
                                break;
                            default:
                                actions = " <button class='btn btn-sm btn-primary btn_upload_sup pr_sup_upload type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"' data-type='"+data.type+"' data-fi='"+field+"'><i class='fa fa-upload'></i> Upload</button> <button class='btn btn-sm btn-danger btn_return_sup pr_sup_return type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"' data-type='"+data.type+"'><i class='fa fa-undo'></i> Return</button> <button class='btn btn-sm btn-info btn_forward_sup pr_sup_forward type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-forward'></i> Forward</button> <button class='btn btn-sm btn-success btn_complete_sup pr_sup_complete type='submit' data-toggle='modal' data-target='#completeModal_sup'data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-check-circle'></i> Complete</button>";
                                break;
                            };
                    ...
                    result.content.forEach(function(data){
                        ...
                        __executeExternalGet('http://localhost:8088/user/'+data.senderId).done(function (result) {
                            ...
                            case "COMPLETED":
                                ...
                                break;
                            default:
                                actions = " <button class='btn btn-sm btn-primary btn_upload_csup pr_csup_upload type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"' data-type='"+data.type+"' data-fi='"+field+"'><i class='fa fa-upload'></i> Upload</button> <button class='btn btn-sm btn-danger btn_return_csup pr_csup_return type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-undo'></i> Return</button> <button class='btn btn-sm btn-info btn_forward_csup pr_csup_forward type='submit' data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-forward'></i> Forward</button> <button class='btn btn-sm btn-success btn_complete_csup pr_csup_complete type='submit' data-toggle='modal' data-target='#completeModal_csup'data-docket='"+data.docketNumber+"' data-id='"+data.id+"'><i class='fa fa-check-circle'></i> Complete</button>";
                                break;
                            };
