...
<body>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header" id="pager">
                                ...
                                <a href="pre-parole-supervision-create"> <button class="btn btn-sm btn-success float-right ppr_sup_add" type="submit"><i class="fa fa-plus-circle"></i> Add Docket</button> </a>
                            </div>
                            <div class="card-body">
    ...
    <script src="assets/js/pisJs/SC_Pre_Parole_Supervision/list.js">
