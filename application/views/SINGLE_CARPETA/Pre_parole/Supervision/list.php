...
<body>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="alert alert-danger" id="sc_ppr_sup_page_error" style="display:none;" role="alert"></div>
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Supervision Docket List</strong>
                                <!-- <a href="pre-parole-supervision-create"> <button class="btn btn-sm btn-success float-right " data-permission="can_create_docket_pre_parole_supervision" type="button"><i class="fa fa-plus-circle"></i> Add Docket</button> </a> -->
                            </div>
                            <div class="card-body">
                                <div class="sup-docket-list-wrap position-relative">
                                    <div id="scPprSupListLoader" class="sup-docket-list-loader" aria-live="polite" aria-busy="true">
                                    ...
                                    <table id="tblScPreParoleSupervision" class="table table_head" width="100%">
    ...
    <script src="assets/js/pisJs/SC_Pre_Parole_Supervision/list.js"></script>
