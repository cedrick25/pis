            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="alert alert-danger" id="sc_ppcinv_page_error" style="display:none;" role="alert"></div>
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Parole and Pardon Courtesy Investigation Docket List</strong>
                                <!-- <a href="pre-parole-courtesy-investigation-create"> <button class="btn btn-sm btn-success float-right " data-permission="can_create_docket_pre_parole_courtesy_investigation" type="submit"><i class="fa fa-plus-circle"></i> Add Docket</button> </a> -->
                            </div>
                            <div class="card-body">
                                <div class="sup-docket-list-wrap position-relative">
                                    <div id="scPpcInvListLoader" class="sup-docket-list-loader" aria-live="polite" aria-busy="true">
                                    ...
                                    <table id="tblScPreParoleCourtesyInv" class="table table_head" width="100%">
                                        <caption class="sr-only">Courtesy investigation dockets for this field office</caption>
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
