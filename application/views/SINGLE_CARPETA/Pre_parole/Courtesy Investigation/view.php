...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">View Courtesy Investigation Docket</strong>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="quick-info">
                                            ...
                                            <input type="text" name="sc_cinv_view_docket" class="form-control docketNum_update" readonly autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="quick-info">
                                            <div class="title">Client</div>
                                            <input type="text" name="sc_cinv_view_client" class="form-control pb_client_sup" readonly autocomplete="name">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        ...
                                                        <input type="text" name="sc_cinv_view_ref_office" class="form-control referring_office_display" readonly autocomplete="organization">
                                                    </div>
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        <label class="field-label">Date Received by the PPO</label>
                                                        <input type="date" class="form-control date_received_by_ppo" name="sc_cinv_view_date_received" readonly>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        <label class="field-label">Investigating Officer</label>
                                                        <input type="text" name="sc_cinv_view_inv_officer" placeholder="Investigating Officer" class="form-control inv_officer" readonly autocomplete="off">
                                                    </div>
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        <label class="field-label">Reasons</label>
                                                        <input type="text" name="sc_cinv_view_reasons" placeholder="Reasons" class="form-control reasons" readonly autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="form-group col-sm-12 col-md-6">
                                                        ...
                                                        <input type="date" class="form-control date_completed_and_returned" name="sc_cinv_view_date_completed" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="assets/js/pisJs/SC_Pre_Parole_Courtesy_Investigation/view.js"></script>
</body>
