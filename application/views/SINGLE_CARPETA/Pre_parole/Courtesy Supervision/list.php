...
<body>
                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <ol class="breadcrumb text-left">
                            ...
                            <li><a href="parole-pardone-courtesy-supervision-list">Parole and Pardon</a></li>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="alert alert-danger" id="sc_ppcsup_page_error" style="display:none;" role="alert"></div>
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Parole and Pardon Courtesy Supervision Docket List</strong>
                                <!-- <a href="pre-parole-courtesy-supervision-create"> <button class="btn btn-sm btn-success float-right " data-permission="can_create_docket_pre_parole_courtesy_supervision" type="submit"><i class="fa fa-plus-circle"></i> Add Docket</button> </a> -->
                            </div>
                            <div class="card-body">
                                <div class="sup-docket-list-wrap position-relative">
                                    <div id="scPpcSupListLoader" class="sup-docket-list-loader" aria-live="polite" aria-busy="true">
                                    ...
                                    <table id="tblScPreParoleCourtesySup" class="table table_head" width="100%">
                                        <caption class="sr-only">Parole and pardon courtesy supervision dockets for this field office</caption>
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
                                                <th scope="col">Docket Number</th>
                                                <th scope="col">Full Name</th>
                                                <th scope="col">Referring Office</th>
    ...
    <script src="assets/js/pisJs/SC_Pre_Parole_Courtesy_Supervision/list.js"></script>
