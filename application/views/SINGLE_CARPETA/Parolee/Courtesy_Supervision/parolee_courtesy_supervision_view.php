...
<body>
                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="parolee_courtesy_supervision_docketing">Parole</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
			                    ...
			                    <div class="row form-group col-md-6">
			                        ...
			                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="e.g John Doe" class="form-control sup_off_update"></div>
			                    </div>
                                <div class="row form-group col-md-6">
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9"><input type="date" class="form-control start_sup_date_update"></div>
                                </div>
                                <div class="row form-group col-md-6">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">End Supervision</label></div>
                                    <div class="col-12 col-md-9"><input type="date" class="form-control end_sup_date_update"></div>
                                </div>
                                
			                    <div class="row form-group col-md-6">
			                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date Courtesy Referral</label></div>
			                        <div class="col-12 col-md-9"><input type="date" class="form-control date_court_ref_update"></div>
			                    </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/js/pisJs/SC_Parolee_Courtesy_Supervision/paroleeCourtesySupervisionView.js">
