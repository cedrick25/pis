...
<body>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header" id="pager">
                                <strong class="card-title">Parole Investigation Docket List</strong>
                                <a href="parolee_investigation_create"> <button class="btn btn-sm btn-success float-right pr_inv_add" style='display:none;' type="submit"><i class="fa fa-plus-circle"></i> Add Docket</button> </a>
                            </div>
                            <div class="card-body">
    ...
    <script src="assets/js/pisJs/SC_Parolee_Investigation/paroleeInvestigationDocketing.js">
