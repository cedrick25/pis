...
<body>
                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Identification Data</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active identification_data" href="#" data-name="Identification Data">Identification Data</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="dropdown-others-wrap" style="display:none;margin-top:8px;">
                                            <input type="text" class="form-control civilStatus_others" placeholder="Specify">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                ...
                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <select class="form-control identifying_marks select2">
                                        ...
                                        <div class="dropdown-others-wrap" style="display:none;margin-top:8px;">
                                            <input type="text" class="form-control identifying_marks_others" placeholder="Specify">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <label for="text-input" class=" form-control-label">Physical Handicap</label>
                                        <textarea class="form-control physical_handicap"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="assets/js/pisJs/worksheetIdentificationData.js"></script>
