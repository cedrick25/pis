...
<!--     <div class="modal fade" id="forwardDocket" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    ...
    <!-- Update modal -->
    <div class="modal fade" id="updateRegionModal" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document" style="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Region Update</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div id="success"></div>
                    <div class="modal-body col-md-12">
                        <div class="row form-group col-md-12">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="NCR" class="form-control region_update form_capitalized"></div>
                        </div>
<!--                         <div class="row form-group col-md-12">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date Created</label></div>
    ...
    <!-- new Docket modal -->
    <div class="modal fade" id="newRegionModal" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document" style="">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body col-md-12">
                    <div class="modal-body col-md-12">
                        <div class="row form-group col-md-12">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Region</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="NCR" class="form-control region form_capitalized"></div>
                        </div>
<!--                         <div class="row form-group col-md-12">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date Created</label></div>
                            <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="description" class="form-control permission_desc_update form_capitalized"></div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-sm btn-success float-right" type="submit" data-toggle="modal" data-target="#newRegionModal"><i class="fa fa-plus-circle"></i> Add Region</button>
                            </div>
                            <div class="card-body">
 ...
 -->                                        </tr>
                                    ...
                                    <tbody class="table_body">
                                        <tr>
                                            ...
                                            <td>NCR</td>
                                            <td>01/20/2023</td>
                                            <td class='actions'> <button class='btn btn-sm btn-primary btn_update' type='submit' data-toggle='modal' data-target='#updateDocketing'><i class='fa fa-refresh'></i> Update</button>
                                            </td>
<!--                                        <td>Test Case</td> 
