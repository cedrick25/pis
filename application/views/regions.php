                ...
                <div class="alert alert-success" role="alert" id="success" style="display:none">
                    ...
                    <div class="modal-body col-md-12">
                        <div class="row form-group col-md-12">
                            ...
                            <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="NCR" class="form-control permission_name_update form_capitalized"></div>
                        </div>
<!--                         <div class="row form-group col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-sm btn-success float-right" type="submit" data-toggle="modal" data-target="#newUserModal"><i class="fa fa-plus-circle"></i> Add Region</button>
                            </div>
                            <div class="card-body">
