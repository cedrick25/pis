...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="sup_tab" data-toggle="tab" href="#sc" role="tab" aria-controls="single_carpeta" aria-selected="false">Single Carpeta</a>
                                    </li>
                                </ul>
    ...
    ( function ( $ ) {
        ...
        var __table_sc = function(){
            ...
            __executeExternalGet('http://localhost:8000/workflow/receiver/'+$.cookie("uuid")+'?page=0&size=100&type=SC').done(function (result) {
                // console.log("==========")
                // console.log(result)
                // console.log("==========")
                if (result.status != "ERROR") {
