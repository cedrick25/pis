...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document" style="max-width: 1100px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Update Received</h5>
    ...
    ( function ( $ ) {
        ...
        //     __executeExternalGet('http://localhost:8000/workflow/sender/'+$.cookie("uuid")).done(function (result) {
        //         console.log("==========")
        //         console.log(result)
        //         console.log("==========")
        //         // if (result.status != "ERROR") {
