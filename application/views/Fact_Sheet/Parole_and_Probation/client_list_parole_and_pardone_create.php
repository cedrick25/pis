                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Enter Crimnal Case Number" class="form-control cc_no"></div>
                                </div>
			                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
...
<!-- 			                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 fieldMiddleName" >
                                ...
                                <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Educ. Attainment</label></div>
    ...
    <script src="assets/js/pisJs/Fact_Sheet/Parole_and_Pardone/client_list_parole_and_pardone_create.js">
