                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="client_list_single_carpeta">Client List</a></li>
...
<!-- 			                    <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 fieldMiddleName" >
                                ...
                                <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
			                        ...
			                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Enter Status" class="form-control status"></div>
			                    </div>
                                <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
			                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Educational Attain</label></div>
			                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Enter Education Attainment" class="form-control educational_attainment"></div>
			                    </div>
                                <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
