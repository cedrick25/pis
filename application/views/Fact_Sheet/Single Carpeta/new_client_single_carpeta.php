                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div class="spinner ml-auto" role="status" aria-hidden="true" id="spinner_update" style="display:none"></div>
                            </div>
                            <div class="card-body">
                                ...
                                <!-- pdl details end -->
                                    ...
                                    <div class="form-row col-sm-12 col-md-12 col-lg-12 col-xl-12 custom-col">
                                        ...
                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex justify-content-end">
                                            <button type="button" class="add_more btn btn-primary btn-success btn-sm float-right" style="margin-right: 20px; display: none;">Add more</button>
                                            ...
                                            <div class="row col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                    <div id="investigation_card_body_accordion">
                                                        <!-- append investigation card through JS -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
