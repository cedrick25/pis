                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Create Investigation</strong>
                            </div>
                            <div class="card-body">
...
<!--                                 <div class="form-row col-12">
                                ...
                                <div class="form-row col-12">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Criminal Case No." class="form-control cc_no"></div>
                                    </div>
                                </div>
                                <div class="form-row col-12">
    			                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
    			                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Offense</label></div>
    			                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Offense" class="form-control offense"></div>
    			                    </div>
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Court of Origin</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Court of Origin" class="form-control court_origin"></div>
                                    </div>
                                </div>
                                <div class="form-row col-12">
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 false_manual">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Officer Doe" class="form-control inv_off"></div>
                                    </div>
                                </div>
                                <div class="form-row col-12">
    			                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="form-row col-12">
                                    <div class="form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="text-input" placeholder="Remarks" class="form-control remarks"></div>
                                    </div>
                                </div>
                            </div>
