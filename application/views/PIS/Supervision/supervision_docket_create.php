...
<body>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row docket_display" style="display:none;">
                                        <div class="row form-group col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="form-row docketing" style="display:none">
                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 class_sel_true" style="display: none;">
                                        ...
                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 manualProbStart">
                                        ...
                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 manualProbYear">
                                        ...
                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 manualProbMonth">
                                        ...
                                        <div class="row form-group col-sm-12 col-md-6 col-lg-6 col-xl-6 manualProbDay">
                                ...
                                <div class="card-footer confirmButton" style="display: none;">
    ...
    <script src="assets/js/pisJs/PIS_Supervision/supervisionDocketCreate.js">
