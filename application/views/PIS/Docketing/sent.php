...
<body>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header" id="pager">
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="inv_tab" data-toggle="tab" style="cursor: pointer;">Investigation Sent</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="sup_tab" data-toggle="tab" style="cursor: pointer;">Supervision Sent</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
    ...
    <script src="assets/js/pisJs/PIS_Docket_Routing/sent.js">
