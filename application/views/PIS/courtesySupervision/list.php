...
<body>
                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <ol class="breadcrumb text-left">
                            ...
                            <li><a href="investigation_docketing">Docket</a></li>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="alert alert-danger" id="csup_docketing_page_error" style="display:none;" role="alert"></div>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="sup-docket-list-wrap position-relative">
                                    <div id="csupDocketListLoader" class="sup-docket-list-loader" aria-live="polite" aria-busy="true">
                                    ...
                                    <table id="tblCourtesySupervisionDockets" class="table table_head" width="100%">
                                        <caption class="sr-only">Courtesy supervision dockets for this field office</caption>
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
    ...
    <script src="assets/js/pisJs/PIS_Courtesy_Supervision/list.js"></script>
