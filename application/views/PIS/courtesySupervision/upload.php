...
<body>
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="investigation_tab" role="tabpanel" aria-labelledby="home-tab">
                                        <table id="courtesy_supervision_uploads_table" class="table table_head table-striped table-bordered" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>File Name</th>
    ...
    <script src="assets/js/pisJs/PIS_Courtesy_Supervision/viewUploadAttachments.js"></script>
