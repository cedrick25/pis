                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select class="form-control sex select2" disabled>
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select class="form-control citizenship select2" disabled>
                                            <option value="" selected disabled>-- select one --</option>
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select class="form-control religion select2" disabled>
                                            <option value="" selected disabled>-- select one --</option>
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9"><input type="date" class="form-control bday" disabled></div>
                                </div>
                                <div class="row form-group col-md-6">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Birth Region</label></div>
                                    <div class="col-12 col-md-9">
                                        <select class="form-control bplace select2" disabled>
                                            <option value="" selected disabled>-- select one --</option>
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select class="form-control identifyingMarks select2" disabled>
                                            <option value="" selected disabled>-- select one --</option>
                                ...
                                <div class="row form-group col-md-6">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select class="form-control parentsRelation select2" disabled>
                                ...
                                <fieldset class="row col col-md-12">
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Birth Date</label></div>
                                            <div class="col-12 col-md-9"><input type="date" class="form-control father_bday" disabled></div>
                                        </div>
                                        <div class="row form-group col-md-6">
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Citizenship</label></div>
                                            <div class="col-12 col-md-9">
                                                <select class="form-control father_citizenship select2" disabled>
                                                    <option value="" selected disabled>-- select one --</option>
                                                    <option value="afghan">Afghan</option>
                                                    <option value="albanian">Albanian</option>
                                                    <option value="algerian">Algerian</option>
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Religion</label></div>
                                            <div class="col-12 col-md-9">
                                                <select class="form-control father_religion select2" disabled>
                                                    <option value="" selected disabled>-- select one --</option>
                                                    <option value="BAPTIST FUNDAMENTAL">Baptist Fundamental</option>
                                                    <option value="BORN AGAIN">Born Again</option>
                                                    <option value="IGLESIA FILIPINA INDEPENDENTE">Iglesia Filipina Independente</option>
                                        ...
                                        <div class="row form-group col-md-6">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select class="form-control father_education select2" disabled>
                                                    <option value="" selected disabled>-- select one --</option>
                                        ...
                                        <div class="row form-group col-md-6">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select class="form-control father_deceased select2" disabled>
                                                    <option selected disabled>-- select one --</option>
                                        ...
                                        <div class="row form-group col-md-6 fatherDateDeceased" style="display: none;">
                                            ...
                                            <div class="col-12 col-md-9"><input type="date" class="form-control father_date_deceased" disabled></div>
                                        </div>
                                </fieldset>
                                ...
                                <fieldset class="row col col-md-12">
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Birth Date</label></div>
                                            <div class="col-12 col-md-9"><input type="date" class="form-control mother_bday" disabled></div>
                                        </div>
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Birth Place</label></div>
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Citizenship</label></div>
                                            <div class="col-12 col-md-9">
                                                <select class="form-control mother_citizenship select2" disabled>
                                                    <option value="" selected disabled>-- select one --</option>
                                                    <option value="afghan">Afghan</option>
                                                    <option value="albanian">Albanian</option>
                                                    <option value="algerian">Algerian</option>
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Religion</label></div>
                                            <div class="col-12 col-md-9">
                                                <select class="form-control mother_religion select2" disabled>
                                                    <option value="" selected disabled>-- select one --</option>
                                                    <option value="BAPTIST FUNDAMENTAL">Baptist Fundamental</option>
                                                    <option value="BORN AGAIN">Born Again</option>
                                                    <option value="IGLESIA FILIPINA INDEPENDENTE">Iglesia Filipina Independente</option>
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Education</label></div>
                                            <div class="col-12 col-md-9">
                                                <select class="form-control mother_education select2" disabled>
                                                    <option value="" selected disabled>-- select one --</option>
                                                    <option value="COLLEGE GRADUATE">College Graduate</option>
                                                    <option value="COLLEGE UNDERGRADUATE">College Undergraduate</option>
                                                    <option value="ELEMENTARY GRADUATE">Elementary Graduate</option>
                                        ...
                                        <div class="row form-group col-md-6">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Deceased</label></div>
                                            <div class="col-12 col-md-9">
                                                <select class="form-control mother_deceased select2" disabled>
                                                    <option selected disabled>-- select one --</option>
                                                    <option value="TRUE">Yes</option>
                                                    <option value="FALSE">No</option>
                                                </select>
                                        ...
                                        <div class="row form-group col-md-6 motherDateDeceased" style="display: none;">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date Deceased</label></div>
                                            <div class="col-12 col-md-9"><input type="date" class="form-control mother_date_deceased" disabled></div>
                                        </div>
                                </fieldset>
